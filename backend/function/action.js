...
const web3 = new Web3(new Web3.providers.HttpProvider('https://rinkeby.infura.io/v3/fa1c02fc32294175860ecd67c027b8d8'));
    ...
    this.transferFund = async function(reciever, amountToSend) {
        return new Promise(async (resolve, reject) => {
            ...
            web3.eth.getBalance(sender, async (err, result) => {
                ...
                let privateKey = '7d94f8d51df5cdc910236b89cd218661f6781fcf2e937abb52e8f7fb45661f36';
